...
class VehicleLightsState:
    def __init__(self):
        ...
        self.navigation_lights_state = 0
        self.has_navigation_lights_state = False
    ...
    def serialize(self, cursor: BitCursor):
        ...
        if self.has_navigation_lights_state:
            self.pv |= (1 << 1)
        ...
        if self.has_navigation_lights_state:
            cursor.write_uint16(self.navigation_lights_state)
    ...
    def deserialize(self, cursor: BitCursor):
        ...
        if self.pv & (1 << 1):
            self.has_navigation_lights_state = True
            self.navigation_lights_state = cursor.read_uint16()
        else:
            self.has_navigation_lights_state = False
