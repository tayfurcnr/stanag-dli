...
class VSMAuthorisationResponse:
    def __init__(self):
        ...
        self.access_authorized = 0
        self.has_access_authorized = False
        
        self.access_granted = 0
        self.has_access_granted = False
        
        self.loi_authorized = 0
        self.has_loi_authorized = False
        
        self.loi_granted = 0
        self.has_loi_granted = False
        
        self.flight_modes_granted = 0
        self.has_flight_modes_granted = False
        ...
        self.access_requested = 0
        self.has_access_requested = False
    ...
    def serialize(self, cursor: BitCursor):
        ...
        if self.has_loi_granted:
            self.pv |= (1 << 6)
        
        if self.has_flight_modes_granted:
            self.pv |= (1 << 7)
        ...
        if self.has_access_authorized:
            cursor.write_uint8(self.access_authorized)
        
        if self.has_access_granted:
            cursor.write_uint8(self.access_granted)
        
        if self.has_loi_authorized:
            cursor.write_uint8(self.loi_authorized)
        
        if self.has_loi_granted:
            cursor.write_uint8(self.loi_granted)
        
        if self.has_flight_modes_granted:
            cursor.write_uint8(self.flight_modes_granted)
        ...
        if self.has_access_requested:
            cursor.write_uint8(self.access_requested)
    ...
    def deserialize(self, cursor: BitCursor):
        ...
        if self.pv & (1 << 3):
            self.has_access_authorized = True
            self.access_authorized = cursor.read_uint8()
        else:
            self.has_access_authorized = False
        
        if self.pv & (1 << 4):
            self.has_access_granted = True
            self.access_granted = cursor.read_uint8()
        else:
            self.has_access_granted = False
        ...
        if self.pv & (1 << 6):
            self.has_loi_granted = True
            self.loi_granted = cursor.read_uint8()
        else:
            self.has_loi_granted = False
        
        if self.pv & (1 << 7):
            self.has_flight_modes_granted = True
            self.flight_modes_granted = cursor.read_uint8()
        else:
            self.has_flight_modes_granted = False
        ...
        if self.pv & (1 << 12):
            self.has_access_requested = True
            self.access_requested = cursor.read_uint8()
        else:
            self.has_access_requested = False
